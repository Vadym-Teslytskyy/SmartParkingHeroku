...
var InterceptorService = /** @class */ (function () {
    function InterceptorService() {
        this.domenUrl = __WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].apiUrl;
    }
    InterceptorService.prototype.intercept = function (request, next) {
        if (request.url.startsWith(this.domenUrl) && (__WEBPACK_IMPORTED_MODULE_3__auth_token_token_storage__["a" /* TokenStorage */].getToken())) {
